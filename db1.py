...
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (1, 1 ,'Batareya', 5_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (2, 2 ,'Televizor', 3_300_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (3, 3 ,'Kompyuter', 8_250_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (4, 4 ,'Kozoynak', 30_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (5, 5 ,'Kozgu', 250_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (6, 6 ,'Sumka', 300_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (7, 7 ,'Taqinchoq', 15_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (8, 8 ,'Uzuk', 3_300_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (9, 9 ,'Kamera', 230_000)""")
cur.execute("""INSERT INTO xaridlar(id , user_id, nomi , narxi) VALUES (10, 10 ,'Kitob', 36_000)""")
